    ...
    if(msg->message == WM_LBUTTONDOWN)
    {
      ...
      if(imageClicksCount > 0)
      {
        ...
        IStream *stream;        
        {
          ...
          stream = 0;//Screenshoot::_screenToIStream(imageFormat, 30, USERCLICK2IMAGE_SIZE);
        }
...
//REMOVED_TEMP//REMOVED_TEMP//REMOVED_TEMP//REMOVED_TEMP//REMOVED_TEMP#if defined HOOKER_SETWINDOWTEXT
