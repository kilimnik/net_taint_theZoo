...
__int64 __stdcall Math::_divI64(__int64 dwA, __int64 dwB)
{
  __asm
  {
    push edi
...
DWORD64 __stdcall Math::_divU64(DWORD64 dwA, DWORD64 dwB)
{
  __asm
  {
    push ebx
...
__int64 __stdcall Math::_modI64(__int64 dwA, __int64 dwB)
{
  __asm
  {
    push ebx
...
DWORD64 __stdcall Math::_modU64(DWORD64 dwA, DWORD64 dwB)
{
  __asm
  {
    push ebx
...
DWORD64 __stdcall Math::_mul64(DWORD64 dwA, DWORD64 dwB)
{
  __asm
  {
    mov  eax, dword ptr[esp + 0x08]
...
DWORD64 __stdcall Math::_shr64(DWORD64 number, BYTE bits)
{
  __asm
  {
    mov  eax, dword ptr[esp + 0x04]
...
int __stdcall Math::_ftoi(float f)
{
  __asm
  {
    push ebx
