...
DWORD WriteOrGetLen_C_CODE(unsigned char *dest,DWORD *repl_data,DWORD exe_LibMain_vadr,DWORD epRVA)
{
	...
	//REMOVED_TEMP//REMOVED_TEMP//REMOVED_TEMP//REMOVED_TEMP//REMOVED_TEMP#ifdef CCRW_BIN
	...
	for (e = 0;; e++)
	{
	 ...
	 //REMOVED_TEMP//REMOVED_TEMP//REMOVED_TEMP//REMOVED_TEMP//REMOVED_TEMP#ifdef ccdbgdbg
