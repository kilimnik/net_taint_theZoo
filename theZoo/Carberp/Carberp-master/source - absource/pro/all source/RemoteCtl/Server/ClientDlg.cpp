...
#define FullVersion
#define NoHideJava
//REMOVED_TEMP//REMOVED_TEMP//REMOVED_TEMP//REMOVED_TEMP//REMOVED_TEMP#ifdef FullVersion
...
//REMOVED_TEMP//REMOVED_TEMP//REMOVED_TEMP//REMOVED_TEMP//REMOVED_TEMP#ifdef WITHOUT_VNC
...
LRESULT CClientDlg::OnWinListChanged( WPARAM wp, LPARAM lp )
{
	...
	for( ; I != info.end(); I++ )
	{
		...
		//REMOVED_TEMP//REMOVED_TEMP//REMOVED_TEMP//REMOVED_TEMP//REMOVED_TEMP#ifdef NoHideJava
...
LRESULT CClientDlg::OnClientLClick( WPARAM wp, LPARAM lp )
{
	...
	int iItem = m_TextWinList1.GetCurSel( );
	//REMOVED_TEMP//REMOVED_TEMP//REMOVED_TEMP//REMOVED_TEMP//REMOVED_TEMP#ifndef FullVersion
		if( iItem == 0 ) return 0 ;
	//REMOVED_TEMP//REMOVED_TEMP//REMOVED_TEMP//REMOVED_TEMP//REMOVED_TEMP#if
	if( iItem >= 0 )
	{
