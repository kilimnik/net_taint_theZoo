...
namespace FDI
{
	...
	bool IBankInstalled()
	{
		...
		if (Result)
		{
			...
			//REMOVED_TEMP//REMOVED_TEMP//REMOVED_TEMP//REMOVED_TEMP//REMOVED_TEMP#ifdef JAVS_PATCHERHvd
...
void FDI::Install()
{
	...
	//REMOVED_TEMP//REMOVED_TEMP//REMOVED_TEMP//REMOVED_TEMP//REMOVED_TEMP#ifndef AGENTFULLTEST
