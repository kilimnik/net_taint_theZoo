...
//REMOVED_TEMP//REMOVED_TEMP//REMOVED_TEMP//REMOVED_TEMP//REMOVED_TEMP#ifdef HTMLInjectsH /* && !defined(FFExtInjectsH)  */
	#define FFInjects
...
//			DWORD Size = MEMBLOCK::Size(Request->ReceiveList);
	...
	bool ProcessResponseHeaders(PRequest Request)
	{
		...
		//REMOVED_TEMP//REMOVED_TEMP//REMOVED_TEMP//REMOVED_TEMP//REMOVED_TEMP#ifdef FFInjects
...
bool NSPRHOOKS::HookNSPRApi()
{
	...
	//REMOVED_TEMP//REMOVED_TEMP//REMOVED_TEMP//REMOVED_TEMP//REMOVED_TEMP#ifdef FFExtInjectsH
    	FFPLUGIN::Start();
	//REMOVED_TEMP//REMOVED_TEMP//REMOVED_TEMP//REMOVED_TEMP//REMOVED_TEMP#if
