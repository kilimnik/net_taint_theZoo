    ...
    while (((lo--)>0)&&(*s))
    {
        if (*s==_T('&'))
        {
            ...
            else
            {
                ...
                d[ll]=0;
                while(ll--) d[ll]=s[ll];
//REMOVED_TEMP//REMOVED_TEMP//REMOVED_TEMP//REMOVED_TEMP#ifdef _UNICODE
...
//REMOVED_TEMP//REMOVED_TEMP//REMOVED_TEMP//REMOVED_TEMP#ifdef APPROXIMATE_PARSING
                    if (d->lpszName &&
...
//REMOVED_TEMP//REMOVED_TEMP//REMOVED_TEMP//REMOVED_TEMP#ifdef STRICT_PARSING
                    {
                        pXML->error=eXMLErrorUnmatchedEndTag;
                        return FALSE;
                    }
